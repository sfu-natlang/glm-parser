...
class DependencyTree():
    ...
    def get_working_array_index(self):
        ...
        :rtype: 
        """
        return self.working_array_index
    ...
    def set_word_list(self,word_list):
        self.word_list = copy.copy(word_list)
        self.working_array[self.WORD_ARRAY] = self.word_list
        return
    ...
    def get_word_list(self):
        ...
        :rtype: list(str)
        """
        return copy.copy(self.word_list)

    def get_word_list_ref(self):
        return self.word_list

    def get_pos_list_ref(self):
    ...
    def get_pos_list(self):
        ...
        :rtype: list(str)
        """
        return copy.copy(self.pos_list)
    ...
    def is_valid(self):
        ...
        """
        if len(self.word_list) != len(self.pos_list):
            return (False,1)
