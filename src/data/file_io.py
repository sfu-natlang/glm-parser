...
def fileReadHDFS(sparkContext=None, filePath=None):
    if filePath == None:
...
def fileWriteHDFS(sparkContext=None, filePath=None, contents=None):
    '''
    Acceptable contents:
        list(array) of data
    '''
...
def fileRead(sparkContext=None, filePath=None):
    if filePath == None:
    ...
    return fileReadHDFS(sparkContext=sparkContext, filePath=filePath)

def fileWrite(sparkContext=None, filePath=None, contents=None):
    '''
    Acceptable contents:
        list(array) of data
    '''
    ...
    return fileWriteHDFS(sparkContext=sparkContext, filePath=filePath, contents=contents)
