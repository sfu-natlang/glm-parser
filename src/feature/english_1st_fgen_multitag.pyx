...
class FeatureGenerator(feature_generator_base.FeatureGeneratorBase):
    ...
    def set_pos_prediction(self, pos_prediction):
        self.pos_prediction = pos_prediction

    def get_unigram_feature(self,
                            head_index,
                            dep_index,
                            direction,
                            dist,
        ...
        if len(xi_word) > 5:
            ...
            local_fv.append( (0,6, xi_word_5, head_pos) )
    ...
    def get_bigram_feature(self,
        ...
        :param head_index: The index of the xi node
        :type head_index: integer
        :paramn dep_index: The index of the xjendency node
        :type dep_index: integer
        """
        local_fv = []
    ...
    def get_in_between_feature(self,
                               head_index,
                               dep_index,
                               direction,
                               dist,
    ...
    def get_surrounding_feature(self,
                                head_index,
                                dep_index,
                                direction,
                                dist,
