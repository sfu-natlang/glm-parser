...
spark-submit --master yarn-cluster --num-executors 8 --driver-memory 10g --executor-memory 10g --py-files module.egg glm_parser.py -i 10 -s 16 -p /cs/natlang-user/vivian/penn-wsj-deps/ --train='wsj_0[2-9][0-9][0-9].mrg.3.pa.gs.tab|wsj_1[0-9][0-9][0-9].mrg.3.pa.gs.tab|wsj_2[0-1][0-9][0-9].mrg.3.pa.gs.tab' --test='wsj_0[0-1][0-9][0-9].mrg.3.pa.gs.tab|wsj_22[0-9][0-9].mrg.3.pa.gs.tab|wsj_24[0-9][0-9].mrg.3.pa.gs.tab' --learner=perceptron --fgen=english_1st_fgen --parser=ceisner --format=/cs/natlang-user/vivian/format/penn2malt.format
